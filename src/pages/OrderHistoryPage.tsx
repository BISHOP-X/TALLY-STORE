...
import { Download, Search, Filter, Package, Clock, CheckCircle, XCircle, RefreshCw, Eye } from 'lucide-react'
...
const mockOrders = [
  {
    id: 'ORD-001',
    productName: 'Instagram Premium Account',
    productId: '1',
    category: 'Instagram',
    amount: 2500,
  ...
  {
    id: 'ORD-002',
    productName: 'TikTok Creator Account',
    productId: '2',
    category: 'TikTok',
    amount: 1800,
    purchaseDate: '2024-11-28T10:15:00Z',
    status: 'delivered',
    downloadUrl: '#',
    credentials: {
      username: 'creator_tiktoker',
      password: 'TikTok2024$',
  ...
  {
    id: 'ORD-003',
    productName: 'Twitter Business Account',
    productId: '3',
    category: 'Twitter',
    amount: 3200,
    purchaseDate: '2024-11-25T16:45:00Z',
    status: 'processing',
    downloadUrl: null,
    credentials: null,
    followers: '50K',
  ...
  {
    id: 'ORD-004',
    productName: 'Facebook Page Account',
    productId: '4',
    category: 'Facebook',
    amount: 2800,
    purchaseDate: '2024-11-20T09:20:00Z',
    status: 'failed',
    downloadUrl: null,
    credentials: null,
    followers: '30K',
...
export default function OrderHistoryPage() {
  ...
  const handleDownload = (order: any) => {
    // In a real app, this would download the account credentials file
    const credentials = {
      orderId: order.id,
